...
- **킥보드 반납 어플리케이션 제약조건 기능 추가**
  ...
  <img src="https://github.com/MFINDUL/Portfolio/blob/main/img/세그멘테이션.png" width="30%" height="30%"/>
  <img src="https://github.com/MFINDUL/Portfolio/blob/main/img/키포인트.png" width="30%" height="30%"/>
